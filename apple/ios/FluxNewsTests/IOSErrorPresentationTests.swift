...
final class IOSErrorPresentationTests: XCTestCase {
    ...
    func testContextsUseStableUserFacingMessages() {
        ...
        XCTAssertEqual(IOSErrorPresentation.message(for: technicalError, context: .feedDiscovery), "FluxNews could not search for feeds at this address.")
        XCTAssertEqual(IOSErrorPresentation.message(for: technicalError, context: .feedCreation), "The feed could not be added.")
        XCTAssertEqual(IOSErrorPresentation.message(for: technicalError, context: .categoryCreation), "The category could not be added.")
