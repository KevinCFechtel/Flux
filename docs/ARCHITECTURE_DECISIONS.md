...
Per-feed preview and full-text limits are independent and
non-destructive: stored complete content is not truncated merely because
the UI requests a shorter representation.
